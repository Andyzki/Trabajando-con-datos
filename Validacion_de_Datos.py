# -*- coding: utf-8 -*-
"""Trabajando con datos 2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wuSAXRzK3eUohRYHUuBVaojYXvNddQCn
...
#Divida sus datos (no olvide importar train_test_split)
from sklearn.model_selection import train_test_split
from sklearn.metrics import mean_absolute_error

train_X, val_X, train_y, val_y = train_test_split(X, y, random_state = 0)

"""Definicion y ajuste del modelo"""
...
# Obtener la presicion de los datos previstos con datos de validación
validacion_predictions = iowa_model.predict(val_X)

"""Calcular el error absoluto medio en los datos de validación"""

# Calculo de error absoluto medio en los datos de validacion
print(mean_absolute_error(val_y, validacion_predictions))